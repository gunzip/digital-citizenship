...
/**
 * Test for /ServiceProviderConfigs
 */
Test('/ServiceProviderConfigs', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getServiceProviderConfigs get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/ServiceProviderConfigs']['get']['responses']['200']['schema']);
