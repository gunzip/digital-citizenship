...
Test('/Users/me', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test replaceMe put operation', function (t) {
            Mockgen().requests({
                path: '/Users/me',
                operation: 'put'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/Users/me']['put']['responses']['200']['schema']);
         ...
         * responses: 200, 400, 401, 403, 404, 409, 502, 504
         */
        t.test('test updateMe patch operation', function (t) {
            Mockgen().requests({
                path: '/Users/me',
                operation: 'patch'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    t.ok(res.statusCode === 200, 'Ok response status');
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/Users/me']['patch']['responses']['200']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
         ...
         */
        t.test('test getMe get operation', function (t) {
            Mockgen().requests({
                path: '/Users/me',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    t.ok(res.statusCode === 200, 'Ok response status');
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/Users/me']['get']['responses']['200']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
