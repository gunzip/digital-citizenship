...
/**
 * Test for /Organizations/{id}/messages
 */
Test('/Organizations/{id}/messages', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test listMessagesByOrganization get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/Organizations/{id}/messages']['get']['responses']['200']['schema']);
