...
/**
 * Test for /Organizations/{id}
 */
Test('/Organizations/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getOrganization get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/Organizations/{id}']['get']['responses']['200']['schema']);
