...
/**
 * Test for /Users/{id}/messages
 */
Test('/Users/{id}/messages', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test listMessagesByUser get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/Users/{id}/messages']['get']['responses']['200']['schema']);
